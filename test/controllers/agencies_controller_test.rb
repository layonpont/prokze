...
class AgenciesControllerTest < ActionController::TestCase
  ...
  test "should create agency" do
    assert_difference('Agency.count') do
      post :create, agency: { city: @agency.city, description: @agency.description, name: @agency.name, phone: @agency.phone, state: @agency.state, website: @agency.website, zipcode: @agency.zipcode }
    end
  ...
  test "should update agency" do
    patch :update, id: @agency, agency: { city: @agency.city, description: @agency.description, name: @agency.name, phone: @agency.phone, state: @agency.state, website: @agency.website, zipcode: @agency.zipcode }
    assert_redirected_to agency_path(assigns(:agency))
  end
