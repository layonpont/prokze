...
class ProfessionalsControllerTest < ActionController::TestCase
  ...
  test "should create professional" do
    assert_difference('Professional.count') do
      post :create, professional: { email: @professional.email, name: @professional.name, phone: @professional.phone, title: @professional.title }
    end
  ...
  test "should update professional" do
    patch :update, id: @professional, professional: { email: @professional.email, name: @professional.name, phone: @professional.phone, title: @professional.title }
    assert_redirected_to professional_path(assigns(:professional))
  end
